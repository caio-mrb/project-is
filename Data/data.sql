...
INSERT INTO containers (name, creation_datetime, application_id)
VALUES 
...
('Notification3', '2024-12-03T14:30:00', 3, 'C', 'http://example.com/notify3', 1),
('Notification4', '2024-12-04T14:45:00', 4, 'D', 'http://example.com/notify4', 1),
('Notification5', '2024-12-05T15:00:00', 5, 'C', 'http://example.com/notify5', 1),
('Notification6', '2024-12-06T15:15:00', 6, 'D', 'http://example.com/notify6', 1),
('Notification7', '2024-12-07T15:30:00', 7, 'C', 'http://example.com/notify7', 1),
('Notification8', '2024-12-08T15:45:00', 8, 'D', 'http://example.com/notify8', 1),
('Notification9', '2024-12-09T16:00:00', 9, 'C', 'http://example.com/notify9', 1),
('Notification10', '2024-12-10T16:15:00', 10, 'D', 'http://example.com/notify10', 1);
